...
<head>
    <meta charset="UTF-8">
    <title>Finance Dashboard - Yearly</title>
    ...
    <div class="content">
            ...
            <div class="stats-section">
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Yearly Total</span>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Yearly Tuition</span>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Yearly Activities</span>
                        <span class="stat-change positive" id="activitiesChange">+20%</span>
                    </div>
                    <div class="stat-value" id="totalActivities">₱1,025,400</div>
                </div>
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Yearly Misc</span>
       ...
       <div class="table-section">
            ...
            <div class="pagination">
                <div class="pagination-info">Showing yearly records</div>
