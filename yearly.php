...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="time-filter">
            ...
            <a href="yearly.php" class="time-btn active">Yearly</a> 
        </div>
            ...
            <div class="stats-section">
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <span class="stat-change positive" id="tuitionChange">+8.2%</span>
                    </div>
                    <div class="stat-value" id="totalTuition">₱3,722,400</div>
                </div>
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Misc Fee</span>
                        <span class="stat-change negative" id="miscChange">-1.5%</span>
                    </div>
                    <div class="stat-value" id="totalMisc">₱1,038,000</div>
                </div>
                <div class="stat-card">
                    <div class="stat-header">
                        <span class="stat-title">Lab Fee</span>
                        <span class="stat-change positive" id="labChange">+20%</span>
                    </div>
                    <div class="stat-value" id="totalLab">₱1,025,400</div>
                </div>
                <div class="stat-card">
                    <div class="stat-header">
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <span class="stat-change positive" id="totalChange">+15.4%</span>
                    </div>
                    <div class="stat-value" id="totalAmount">₱5,785,800</div>
                </div>
            </div>

            <div class="chart-section">
                <div class="chart-header">
                    <h3>Fees Collection (This Year)</h3>
       ...
       <div class="table-section">
            ...
            <table>
                ...
                <tbody id="tableBody">
                    ...
                    // 1. Get the first day of the current year (e.g., 2026-01-01)
                    $startOfYear = date('Y-01-01');

                    // 2. Filter SQL to only include students added this year
                    $sql = "SELECT * FROM students 
                            WHERE DATE(created_at) >= '$startOfYear' 
                    ...
                    if ($result === false) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // Calculate fees (Tuition, Misc, Lab, Uniform, ID)
                        ...
                        echo "<tr><td colspan='14' style='text-align:center; padding: 40px; color: #64748b;'>No records found for the year " . date('Y') . ".</td></tr>";
                    }
