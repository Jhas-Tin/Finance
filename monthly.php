       ...
       <div class="table-section">
            ...
            <table>
                ...
                <tbody id="tableBody">
                    ...
                    // 1. Get the first day of the current month (e.g., 2026-02-01)
                    $startOfMonth = date('Y-m-01');

                    // 2. Update SQL to filter for records created on or after the 1st of this month
                    ...
                    if ($result === false) {
                        ...
                        echo "<tr><td colspan='14' style='text-align:center; padding: 40px; color: #64748b;'>No records found for " . date('F Y') . ".</td></tr>";
                    }
